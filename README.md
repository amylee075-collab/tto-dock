...
| 데이터 | 정적 데이터(`lib/data.ts`) + localStorage 챌린지 |
...
- [알고리즘 정리](docs/ALGORITHM_OVERVIEW.md) — WPM 측정, 문장·어휘 분할, 챌린지 저장소, 마이페이지 피드백·배지 등 핵심 로직 설명
- [썸네일 이미지 가이드](docs/THUMBNAIL_IMAGE_GUIDE.md) — 읽기 목록용 썸네일 이미지 규격 및 등록 방법
